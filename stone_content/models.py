...
class GeneralInformation(models.Model):
    ...
    alt_name = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Alternativname")
    )
    eng_name = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Englischer Name")
    )
    dunham_class = ChoiceArrayField(
        models.CharField(choices=DUNHAM_CHOICES.choices(), max_length=1, blank=True),
        null=True,
        blank=True,
        verbose_name=_("Dunham Klassifikation"),
    )
    add_class = ChoiceArrayField(
        models.CharField(choices=ADD_CLASS_CHOICES.choices(), max_length=2, blank=True),
        null=True,
        blank=True,
...
class Characteristic(models.Model):
    ...
    sed_fabric = ChoiceArrayField(
        models.CharField(choices=SEDIMENT_CHOICES.choices(), max_length=2, blank=True),
        null=True,
        blank=True,
        verbose_name=_("Gefüge (Sediment)"),
    )
    ign_fabric = ChoiceArrayField(
        models.CharField(choices=IGNEOUS_CHOICES.choices(), max_length=2, blank=True),
        null=True,
        blank=True,
    ...
    fabric_comment = models.TextField(
        max_length=256, null=True, blank=True, verbose_name=_("Gefüge Anmerkung")
    )
    grain_size = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Korngröße")
    )
    color_index = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Farbzahl M'")
    )
    color = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Farbe")
    )
    density = DecimalRangeField(null=True, blank=True, verbose_name=_("Dichte [g/cm³]"))
    porosity = models.CharField(
        choices=POROSITY_CHOICES.choices(),
        max_length=11,
        blank=True,
        null=True,
        verbose_name=_("Porosität"),
    )
...
class Composition(models.Model):
    ...
    compounds = models.CharField(
        max_length=256,
        blank=True,
        null=True,
        verbose_name=_("Mineralbestandteile"),
    ...
    mineraltype_compounds = models.ManyToManyField(
        to=MineralType, null=True, blank=True, verbose_name=_("Mineralien im Bestand")
    )
    crystal_percent = DecimalField(
        decimal_places=2,
        max_digits=6,
        blank=True,
        null=True,
    ...
    components = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Komponenten")
    )
    matrix = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Matrix")
    )
    cementation = models.CharField(
        choices=CEMENTATION_CHOICES.choices(),
        max_length=1,
        blank=True,
        null=True,
        verbose_name=_("Zement"),
    )
...
class Emergence(models.Model):
    reagent = models.TextField(
        max_length=512, null=True, blank=True, verbose_name=_("Edukt")
    )
    formation = models.TextField(
        max_length=512, null=True, blank=True, verbose_name=_("Bildung")
    )
    locality = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Lokalität")
    )
    age = models.CharField(
        max_length=256, null=True, blank=True, verbose_name=_("Alter")
    )
